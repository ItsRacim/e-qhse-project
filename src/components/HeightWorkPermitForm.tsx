...
const cellInputCls =
  "w-full rounded-md border border-slate-300 bg-white px-2 py-1.5 text-sm text-slate-800 outline-none transition focus:border-orange-500 focus:ring-2 focus:ring-orange-500";
                ...
                >
                  <td className="px-3 py-2 align-top">
                    <input
                      ...
                      placeholder={t("heightWork.workerNamePlaceholder")}
        ...
        <button
          ...
          onClick={() =>
            update({
              ...
              personnel: [
                ...details.personnel,
                { name: "", harnessSerial: "", trainingDate: "", signature: "" },
              ],
            })
          }
